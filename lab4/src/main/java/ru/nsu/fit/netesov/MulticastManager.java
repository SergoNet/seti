...
public class MulticastManager {
    ...
    public MessageWithSender receivePacket() throws InterruptedException {return receiveQueue.take();}
    ...
    private void receiveWorker() {
        ...
        while (true) {
            ...
            try {
                ...
                receiveQueue.add(MessageWithSender.builder().ip(receivePacket.getAddress().getHostAddress()).port(receivePacket.getPort())
                                .message(gameMessage).build());
            } catch (IOException e) {
    ...
    private void sendWorker() {
        while (true) {
            ...
            try {
                var packet = new DatagramPacket(sendData, sendData.length,
                        InetAddress.getByName(Config.MULTICAST_GROUP_IP), Config.MULTICAST_PORT
                );
